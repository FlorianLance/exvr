...
The project has been developped at [EPFL LNCO laboratory](https://www.epfl.ch/labs/lnco/) (Laboratory of Cognitive Neuroscience) and has been funded by the [EPFL Open Science Fund](https://www.epfl.ch/research/open-science/in-practice/open-science-fund/) from the 2019 cohort.


## Content

ExVR is subdivided in two software:
* ExVR-desinger: a GUI for creating the experiments and controlling their execution
  * creation
