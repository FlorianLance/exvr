...
Varyings Vertex(Attributes input){
    ...
    col *= LinearToGammaSpace(_Tint.rgb) * 1;
    col = GammaToLinearSpace(col);

    Varyings o;
    o.position = UnityObjectToClipPos(pos);
	o.color =  half4(col, input.color.a);
...
//	//half4 c = half4(input.color.rgb, 0.9);// , _Tint.a);
//	//UNITY_APPLY_FOG(input.fogCoord, input.color.rgb);
//	return input.color;
//#endif
//}
