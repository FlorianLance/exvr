...
//                        Converter.to_string(ellapsed_time_exp_ms()), 
//                        Converter.to_string(ellapsed_time_routine_ms())
//                    ); 
...
//            if (m_keyboard != null) {
//                // trigger event
//                var slot = events().get_slot("keyboard button");
//                var signal = m_keyboard.events().get_signal("button");
//                slot.connect(signal);
//            }
