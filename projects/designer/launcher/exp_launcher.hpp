...
public slots:
    ...
    void update_component_config_argument(ComponentKey componentKey, ConfigKey configKey, QString name, Arg arg, bool initConfig);
    void trigger_component_config_action(ComponentKey componentKey, ConfigKey configKey, QString name, bool initConfig);
