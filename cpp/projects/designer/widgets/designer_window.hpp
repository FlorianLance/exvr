...
public:
    ...
    explicit DesignerWindow(bool onlyPublicComponents, bool onlyStableComponents, QWidget *parent = nullptr);
...
private:
    ...
    void create_components_manager(bool onlyPublicComponents, bool onlyStableComponents);
