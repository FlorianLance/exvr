...
TEST_CASE("Experiments loading"){
    ...
    REQUIRE(!xmlIoM.load_dropped_experiment_file(""));
    REQUIRE(!xmlIoM.load_dropped_experiment_file("///"));
    REQUIRE(!xmlIoM.load_dropped_experiment_file("../../../.."));
    REQUIRE(!xmlIoM.load_dropped_experiment_file("\aàé_gub"));

    REQUIRE(xmlIoM.load_dropped_experiment_file(Paths::expDir % QSL("/examples/button_press_reaction_time_using_connections.xml")));
    REQUIRE(xmlIoM.load_dropped_experiment_file(Paths::expDir % QSL("/examples/camera_trajectories.xml")));
    REQUIRE(xmlIoM.load_dropped_experiment_file(Paths::expDir % QSL("/examples/image.xml")));
    REQUIRE(xmlIoM.load_dropped_experiment_file(Paths::expDir % QSL("/examples/input_controllers.xml")));
    REQUIRE(xmlIoM.load_dropped_experiment_file(Paths::expDir % QSL("/examples/keyboard_with_slider.xml")));
    REQUIRE(xmlIoM.load_dropped_experiment_file(Paths::expDir % QSL("/examples/logger_conditions_sample.xml")));
    REQUIRE(xmlIoM.load_dropped_experiment_file(Paths::expDir % QSL("/examples/read_write_udp.xml")));
    REQUIRE(xmlIoM.load_dropped_experiment_file(Paths::expDir % QSL("/examples/slider_moving_value.xml")));
    REQUIRE(xmlIoM.load_dropped_experiment_file(Paths::expDir % QSL("/examples/write_data_to_csv_using_connections.xml")));
    REQUIRE(xmlIoM.load_dropped_experiment_file(Paths::expDir % QSL("/examples/write_data_to_file_using_scripting.xml")));

    REQUIRE(xmlIoM.load_dropped_experiment_file(Paths::expDir % QSL("/debug/test_duplicated_connections.xml")));
